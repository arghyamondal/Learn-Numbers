...
- (void)viewDidLoad{
   ...
   imagesArrayBottomFrame=[[NSArray alloc] initWithObjects:@"1.png", @"2.png",@"3.png",@"4.png",@"5.png",@"6.png",@"7.png",@"8.png",@"9.png",@"10.png",@"11.png",@"12.png",@"13.png",@"14.png",@"15.png",@"16.png",@"17.png",@"18.png",@"19.png",@"20.png", nil];
    ...
    for (i = 0; i<=device; i++) {
        ...
        randomImgNum[i] = arc4random_uniform(8);
        
        rancount[i]=randomImgNum[i];
        
       // UIImage *img1=[UIImage imageNamed:@"num1.png"];
        //UIImage *img2=[UIImage imageNamed:@"num1.png"];
        
        NSString *imageName = [imagesArrayTopFrame objectAtIndex:randomImgNum[i]];
        UIImage *img1 = [UIImage imageNamed:imageName];
        
        NSString *imageName2 = [imagesArrayBottomFrame objectAtIndex:randomImgNum[i]];
        
        UIImage *img2 = [UIImage imageNamed:imageName2];
        
        NSData *binaryimg1=UIImageJPEGRepresentation(img1, 1);
        NSData *binaryimg2=UIImageJPEGRepresentation(img2, 1);
